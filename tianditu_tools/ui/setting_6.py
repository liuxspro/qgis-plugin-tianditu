...
class Ui_SettingDialog(object):
    def setupUi(self, SettingDialog):
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=SettingDialog)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=self.tab_keyset)
        ...
        self.mLineEdit_key = QgsPasswordLineEdit(parent=self.groupBox)
        font = QtGui.QFont()
        ...
        self.saveButton = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.keyComboBox = QtWidgets.QComboBox(parent=self.groupBox)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.checkBox_key_rand = QtWidgets.QCheckBox(parent=self.groupBox)
        self.checkBox_key_rand.setObjectName("checkBox_key_rand")
        self.horizontalLayout_2.addWidget(self.checkBox_key_rand)
        self.pushButton_copy = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.subdomainComboBox = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.subdomainComboBox.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.InsertAtTop)
        self.subdomainComboBox.setObjectName("subdomainComboBox")
        self.horizontalLayout_3.addWidget(self.subdomainComboBox)
        self.checkBox_domain_rand = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.info_status = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.btn_checkupdate = QtWidgets.QPushButton(parent=self.tab_map)
        ...
        self.label_checkstatus = QtWidgets.QLabel(parent=self.tab_map)
    ...
    def retranslateUi(self, SettingDialog):
        ...
        self.label_4.setText(_translate("SettingDialog", "<html><head/><body><style>p { margin: 0.5px;font-size:10px} </style><a href=\"https://cloudcenter.tianditu.gov.cn/center/development/myApp\"><span style=\" font-weight:600; text-decoration: underline; color:#808080;\">点击此处前往天地图申请 Key</span></a>\n"
